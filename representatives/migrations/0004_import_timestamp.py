...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RepresentativeSet.last_import_time'
        db.add_column(u'representatives_representativeset', 'last_import_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Election.last_import_time'
        db.add_column(u'representatives_election', 'last_import_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RepresentativeSet.last_import_time'
        db.delete_column(u'representatives_representativeset', 'last_import_time')

        # Deleting field 'Election.last_import_time'
        db.delete_column(u'representatives_election', 'last_import_time')
